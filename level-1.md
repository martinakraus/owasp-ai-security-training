...
* Falls sensible Infos im Prompt unvermeidbar sind: eine **unabhängige Ausgabe-Prüfschicht** (Guardrail) einsetzen, die NICHT vom selben Modell kontrolliert wird, das den Prompt kennt.
